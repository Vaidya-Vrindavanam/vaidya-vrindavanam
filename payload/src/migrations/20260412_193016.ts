...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_treatments_category" AS ENUM('panchakarma', 'massage', 'speciality');
  CREATE TYPE "public"."enum_blog_category" AS ENUM('health-tips', 'treatment-guides', 'seasonal-advice', 'patient-education');
  ...
  CREATE TABLE "treatments_conditions" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"slug" varchar
  ...
  CREATE TABLE "treatments" (
  	...
  	"category" "enum_treatments_category" NOT NULL,
  	"duration" varchar,
  ...
  CREATE TABLE "blog" (
  	...
  	"author" varchar DEFAULT 'Dr. Jayakrishnan T J',
  ...
  ALTER TABLE "treatments_conditions" ADD CONSTRAINT "treatments_conditions_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."treatments"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "conditions_treatments" ADD CONSTRAINT "conditions_treatments_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."conditions"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "treatments_conditions_order_idx" ON "treatments_conditions" USING btree ("_order");
  CREATE INDEX "treatments_conditions_parent_id_idx" ON "treatments_conditions" USING btree ("_parent_id");
  ...
  CREATE INDEX "conditions_treatments_order_idx" ON "conditions_treatments" USING btree ("_order");
  CREATE INDEX "conditions_treatments_parent_id_idx" ON "conditions_treatments" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "treatments_conditions" CASCADE;
  DROP TABLE "treatments" CASCADE;
  DROP TABLE "conditions_treatments" CASCADE;
